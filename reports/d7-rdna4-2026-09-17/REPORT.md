...
| Final normalization/layout | Correctness repair | 0.003 | 0.006 | +0.003 | 306/320; 230/320 | 320/320; 320/320 | Preserve final-normalization reduction and the BF16 rounding of its retained residual sum; isolated check includes that fused addition. |
| Full BF16 target head | Correctness + performance | 4.101 | 4.134 | +0.033 | 320/320; 320/320 | 320/320; 320/320 | Interleave two arithmetic-preserving M4 groups in one HIP launch, removing duplicated launch and concatenation overhead. |
